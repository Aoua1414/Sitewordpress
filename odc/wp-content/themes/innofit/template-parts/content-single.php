		...
		<div class="post-content">	
			<?php $innofit_blog_meta_section_enable = get_theme_mod('blog_meta_section_enable',true);
				if($innofit_blog_meta_section_enable ==true) { 
					if(get_theme_mod('innofit_enable_single_post_date',true)===true || get_theme_mod('innofit_enable_single_post_category',true)==true || get_theme_mod('innofit_enable_single_post_tag',true)===true): ?>
						<div class="entry-meta">

							<?php if(get_theme_mod('innofit_enable_single_post_date',true)===true):?>
							...
							if(get_theme_mod('innofit_enable_single_post_category',true)==true):	
							...
							if(get_theme_mod('innofit_enable_single_post_tag',true)===true):
			...
			<?php if($innofit_blog_meta_section_enable ==true) { 
				if(get_theme_mod('innofit_enable_single_post_admin',true)===true):?>
					<hr>
					<div class="item-meta">
