...
function innofit_custom_light() {
	...
	$link_color = esc_attr(get_theme_mod('link_color','#2a83e8'));
...
.page-breadcrumb > li a:hover, .page-breadcrumb > li a:focus, .page-breadcrumb > li.active a, .woocommerce .woocommerce-breadcrumb a:hover,.woocommerce .woocommerce-breadcrumb a:focus,.woocommerce .woocommerce-breadcrumb a:active,.woocommerce .woocommerce-breadcrumb:last-child{ color: <?php echo $link_color; ?> }
...
.footer-sidebar .widget.widget_block p a:hover { color: <?php echo $link_color; ?> !important; }
</style>
<?php endif; } ?>
